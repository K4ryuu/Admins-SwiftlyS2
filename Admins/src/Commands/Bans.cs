...
public partial class AdminCommands
{
    ...
    private void RemoveBanBySteamID(ICommandContext context, ulong steamId64)
    {
        ...
        var message = bans.Count > 0
            ? localizer[messageKey, Admins.Config.CurrentValue.Prefix, adminName, bans.Count, steamId64]
            : localizer[messageKey, Admins.Config.CurrentValue.Prefix, steamId64];
    ...
    private void RemoveBanByIP(ICommandContext context, string ipAddress)
    {
        ...
        var message = bans.Count > 0
            ? localizer[messageKey, Admins.Config.CurrentValue.Prefix, adminName, bans.Count, ipAddress]
            : localizer[messageKey, Admins.Config.CurrentValue.Prefix, ipAddress];
        context.Reply(message);
    }
